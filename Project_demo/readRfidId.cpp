...
/**
 * @brief  防碰撞，获取范围内最大的ID，该ID值就是一个电子标签的ID值
 *
 * @param
 * @return
**/
...
#if 0
int readCardId(QString dev_tty = USART2)
{
//#ifdef Q_OS_LINUX
   QByteArray array = dev_tty.toUtf8();
   const char* tty = array.data();
